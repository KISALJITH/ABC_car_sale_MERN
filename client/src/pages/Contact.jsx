            ...
            <Row>
                ...
                <Col lg='5' md='5'>
                    <div className="contact__info">
                        ...
                        No 218/C, Divulapitiya, Boralesgamuwa, Nugegoda
                        </p>
                        <div className="d-flex align-items-center gap-2">
                            <h6 className='mb-0 fs-6'>Phone:</h6>
                            <p className="section__description mb-0">+94 77 347 3430</p>
                        </div>
                        <div className="d-flex align-items-center gap-2">
                            <h6 className='mb-0 fs-6'>Email:</h6>
                            <p className="section__description mb-0">agcnandika@gmail.com</p>
                        </div>
